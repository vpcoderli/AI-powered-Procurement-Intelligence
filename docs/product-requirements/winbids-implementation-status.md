...
| Admin | Full platform operator | Admin console, crawler/source tools, user management, tier assignment, feature overrides, audit visibility, subscription reconciliation. |

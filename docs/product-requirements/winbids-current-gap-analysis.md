...
### 50-State Crawler Quality Batch 8

Scope:

- Keep the 50-state registry as the scheduler/admin source of truth.
- Choose the next generic states from AZ/ID/LA/MD/MI/NE/NC/ND/VT and replace their generic adapters with source-specific fetchers.
...
1. 50-State Crawler Quality Batch 8: dedicated adapters for the next generic states, plus live validation and richer capability notes.
